...
func (manager *ClientManager) EventLogin(login *login) {
	...
	SendUserMessageAll(login.RoomId, login.UserId, orderId, model.MessageCmdEnter, "哈喽~")
}
...
func (manager *ClientManager) EventUnregister(client *Client) {
	...
	if client.UserId != "" {
		orderId := common.GetOrderIdTime()
		SendUserMessageAll(client.RoomId, client.UserId, orderId, model.MessageCmdExit, "用户已经离开~")
	}
}
